                            ...
                            <div class="mb-8">
                                <div class="flex items-center gap-2 mb-4">
                                    ...
                                    <div class="flex gap-2">
                                        <a href="#" class="share-button w-8 h-8 rounded-full bg-primary flex items-center justify-center text-white hover:bg-blue-700 transition-colors" data-share="facebook" aria-label="Share on Facebook">
                                        ...
                                        <a href="#" class="share-button w-8 h-8 rounded-full bg-blue-700 flex items-center justify-center text-white hover:bg-blue-800 transition-colors" data-share="linkedin" aria-label="Share on LinkedIn">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
