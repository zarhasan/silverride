...
if ( empty( $sections ) ) {
    $sections = [
        [
            ...
            'content' => '<p>This policy complies with 49 CFR Part 655, as amended and 49 CFR Part 40, as amended. Copies of Parts 655 and 40 are available in the drug and alcohol program manager\'s office and can be found on the internet at the Federal Transit Administration (FTA) Drug and Alcohol Program website.</p><p class="mt-4"><a href="http://transit-safety.fta.dot.gov/DrugAndAlcohol/" class="text-blue-700 underline hover:text-blue-900 transition-colors duration-200">http://transit-safety.fta.dot.gov/DrugAndAlcohol/</a></p><p class="mt-4">All covered employees are required to submit to drug and alcohol tests as a condition of employment in accordance with 49 CFR Part 655.</p><p class="mt-4">Portions of this policy are not FTA-mandated, but reflect SilverRide Inc.\'s policy. These additional provisions are identified by <strong>bold text</strong>.</p><p class="mt-4">In addition, DOT has published 49 CFR Part 32, implementing the Drug-Free Workplace Act of 1988, which requires the establishment of drug-free workplace policies and the reporting of certain drug-related offenses to the FTA.</p><p class="mt-4"><strong>All SilverRide Inc. employees are subject to the provisions of the Drug-Free Workplace Act of 1988.</strong></p><p class="mt-4"><strong>The unlawful manufacture, distribution, dispensation, possession or use of a controlled substance is prohibited in the covered workplace. An employee who is convicted of any criminal drug statute for a violation occurring in the workplace shall notify the local DER no later than five days after such conviction.</strong></p>',
        ],
        [
            'heading' => '2.0 Covered Employees',
            'id'      => 'covered-employees',
            'content' => '<p>This policy applies to every person, including an applicant or transferee, who performs or will perform a "safety-sensitive function" as defined in Part 655, section 655.4.</p><p class="mt-4">You are a covered employee if you perform any of the following:</p><ul class="list-disc pl-6 mt-2 space-y-1"><li>Operating a revenue service vehicle, in or out of revenue service</li><li>Operating a non-revenue vehicle requiring a commercial driver\'s license</li><li>Controlling movement or dispatch of a revenue service vehicle</li><li>Maintaining (including repairs, overhaul and rebuilding) of a revenue service vehicle or equipment used in revenue service</li><li>Carrying a firearm for security purposes</li></ul><p class="mt-4">See <a href="#attachment-a-covered-positions" class="text-blue-700 underline hover:text-blue-900 transition-colors duration-200">Attachment A</a> for a list of covered positions by job title.</p>',
        ],
        [
        ...
        [
            ...
            'id'      => 'contact-person',
            'content' => '<p>For questions about SilverRide Inc.\'s anti-drug and alcohol misuse program, contact the company DAPM, Santosh Kurnaz.</p><p class="mt-2"><a href="mailto:santoshk@silverride.com" class="text-blue-700 underline hover:text-blue-900 transition-colors duration-200">santoshk@silverride.com</a></p><p class="mt-4">Or in Southern California, the local DAPM, Duijuan Gutierrez, <a href="mailto:Duijuan@silverride.com" class="text-blue-700 underline hover:text-blue-900 transition-colors duration-200">Duijuan@silverride.com</a>.</p>',
        ],
    ];
}
?>
        ...
        <div class="sticky top-[10rem]">
          ...
          <nav aria-label="Table of contents" class="mt-4">
            <ul class="space-y-3 border-l-2 border-gray-200 pl-4">
              ...
              ?>
              <li>
                <a href="#<?php echo esc_attr( $toc_id ); ?>" class="block text-sm text-gray-600 transition-colors duration-200 hover:text-blue-900 hover:underline">
                  <?php echo esc_html( $toc_label ); ?>
                </a>
              </li>
              <?php endforeach; ?>
              <li>
                <a href="#attachment-a-covered-positions" class="block text-sm text-gray-600 transition-colors duration-200 hover:text-blue-900 hover:underline">
