    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-12 lg:py-16">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div class="lg:col-span-5 space-y-8">
                <a href="<?php echo esc_url(home_url('/')); ?>" class="inline-flex flex-col text-primary no-underline">
                    <span class="text-5xl font-bold tracking-tight leading-none">SilverRide</span>
                    <span class="text-sm font-semibold tracking-[0.25em] mt-2 uppercase text-primary">There With Care</span>
                </a>
    ...
    <div class="border-t border-gray-200 py-6">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex items-center gap-4">
                    <a href="#" class="text-primary hover:text-primary transition-colors duration-200" aria-label="LinkedIn">
