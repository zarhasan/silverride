...
<section class="my-16 md:my-24 <?php echo $bg_class; ?>" <?php echo $background_color ? 'style="' . $bg_style . '"' : ''; ?> data-section-id="<?php echo esc_attr($template_part_name); ?>">
    <div class="container">
        ...
        <div class="flex flex-col lg:grid gap-6 md:gap-8" style="grid-template-columns: repeat(<?php echo $total_cols; ?>, minmax(0, 1fr));">
            ...
            ?>
            <div class="border-2 rounded-lg p-6 bg-white text-center" style="border-color: var(--theme-primary); grid-column: span <?php echo $span; ?>;">
                ...
                <?php if ($item_title) : ?>
                    <?php if ($has_link) : ?>
                        <h3 class="text-2xl font-semibold text-[#1B1B1B] mb-3">
                            <a href="<?php echo esc_url($item_link['url']); ?>" class="hover:underline">
                                <?php echo esc_html($item_title); ?>
                            </a>
                        </h3>
                    <?php else : ?>
                        <h3 class="text-2xl font-semibold text-[#1B1B1B] mb-3"><?php echo esc_html($item_title); ?></h3>
                    <?php endif; ?>
                <?php endif; ?>
