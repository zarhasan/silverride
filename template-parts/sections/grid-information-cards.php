...
$cta = $args['cta'] ?? [];
$disable_margins = $args['disable_margins'] ?? false;
...
$margin_class = $disable_margins ? '' : 'my-16 md:my-24';
?>

<section class="<?php echo $margin_class; ?> <?php echo $bg_class; ?>" <?php echo $background_color ? 'style="' . $bg_style . '"' : ''; ?> data-section-id="<?php echo esc_attr($template_part_name); ?>">
    <div class="container">
        ...
        <div class="flex flex-col lg:grid gap-6 md:gap-8" style="grid-template-columns: repeat(<?php echo $total_cols; ?>, minmax(0, 1fr));">
            ...
            ?>
            <div class="rounded-lg p-6 text-left" style="grid-column: span <?php echo $span; ?>; background-color: <?php echo esc_attr($alternate_bg); ?>;">
