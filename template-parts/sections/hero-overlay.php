    ...
    <div class="container relative z-10 py-20 md:py-28">
        <div class="max-w-2xl mt-28">
            ...
            <?php if (!empty($description)) : ?>
                <div class="prose text-lg md:text-xl text-blue-100 leading-relaxed mb-10 a11y_irrbg">
            ...
            <?php if (!empty($links)) : ?>
                <div class="flex flex-wrap gap-4">
                    ...
                    ?>
                        <a href="<?php echo esc_url($link['url'] ?? '#'); ?>" class="a11y_irrbg inline-flex items-center justify-center px-8 py-3 md:px-10 md:py-4 text-base md:text-lg font-semibold text-white border-2 border-white rounded-full hover:bg-white hover:text-primary transition-colors duration-200">
