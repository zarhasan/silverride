<?php
/**
 * Navigation / Who We Serve Stats Section
 *
 * Expected $args (from ACF flexible content or direct call):
 * - stats: array of stat arrays
 *   - value: string (e.g. '1M+')
 *   - label: string (e.g. 'Rides Delivered Each Year')
