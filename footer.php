...
<footer class="bg-white" data-section-id="<?php echo esc_attr($template_part_name); ?>">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 pt-16 pb-12">
        <h2 class="text-3xl lg:text-4xl font-bold text-blue-800 text-center leading-tight">
    ...
    <div class="border-t border-gray-200 py-6">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-6">
                <a href="#" class="inline-flex items-center justify-center px-6 py-2 text-sm font-semibold text-white bg-blue-900 rounded-full hover:bg-blue-800 transition-colors duration-200">
                    Partner Login
                </a>
                
                <div class="flex items-center gap-4">
                    <a href="#" class="text-blue-700 hover:text-blue-900 transition-colors duration-200" aria-label="LinkedIn">
                    ...
                    <a href="#" class="text-blue-600 hover:text-blue-800 transition-colors duration-200" aria-label="Facebook">
